...
impl ImageCacheService {
    pub fn shared_from_app_config(config: &AppConfig) -> Arc<Self> {
    ...
    pub fn from_resolved_config(config: ResolvedImageCacheConfig) -> Self {
    ...
    pub async fn release_protection_best_effort(&self, namespace: HoldNamespace, owner_id: &str) {
...
impl SourceImageSession {
    pub async fn lookup_cached_config(&self) -> Result<CachedImageConfig> {
    ...
    pub async fn begin_conversion(&self) -> Result<ImageCacheOperationHold> {
        self.image_cache.ensure_layout().await?;
        self.image_cache
            .begin_hard_commit_operation("oci-conversion")
    }

    pub async fn complete_cached_metadata(
        &self,
...
impl ImageCacheService {
    ...
    pub async fn lookup_image_config(
        self: &Arc<Self>,
        manifest_digest: &str,
        repository_scope: Option<&str>,
    ...
    pub async fn begin_image_conversion(
        self: &Arc<Self>,
        manifest_digest: &str,
        repository_scope: Option<&str>,
    ...
    pub async fn publish_image_config(
        self: &Arc<Self>,
        manifest_digest: &str,
        repository_scope: Option<&str>,
    ...
    pub async fn write_image_metadata(
        self: &Arc<Self>,
        manifest_digest: &str,
        repository_scope: Option<&str>,
        metadata: ImageResolutionMetadata,
    ...
    pub fn overlaybd_layer_location(
        &self,
        digest: &str,
        size: u64,
        has_remote: bool,
...
impl ImageCacheOperationHold {
    ...
    pub async fn release_best_effort(mut self, reason: &str) {
        self.released = true;
