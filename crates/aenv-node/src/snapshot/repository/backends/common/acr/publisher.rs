...
#[derive(Debug)]
pub struct DiskImageExportOutcome {
...
impl Default for AcrDiskImageExporter {
    fn default() -> Self {
        Self::new()
    }
}
...
pub fn validate_snapshot_tag(tag: &str) -> RepositoryResult<()> {
...
mod tests {
    ...
    use aenv_core::snapshot::repository::backends::common::acr::fake_registry::{
        client as test_client, fake_server, FakeState,
    };
