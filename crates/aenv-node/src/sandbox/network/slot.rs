...
pub fn host_ns_fd() -> BorrowedFd<'static> {
    HOST_NS_FD
        .get_or_init(|| {
...
impl Slot {
    ...
    pub fn create_network(&self) -> Result<(), NetworkError> {
    ...
    pub fn guest_dns_server(&self) -> Ipv4Addr {
        resolve_guest_dns_server()
    }

    pub fn namespace_path(&self) -> std::path::PathBuf {
    ...
    pub fn cleanup(&self, force_sync: bool) -> Result<(), NetworkError> {
