...
pub struct CanonicalBlobIdentity {
    pub key: String,
...
impl CanonicalBlobIdentity {
    ...
    pub fn from_origin_url(url: &str) -> Result<Self> {
...
impl LayerMetadata {
    ...
    pub fn from_uuid(uuid: Uuid, size: Option<u64>) -> Self {
    ...
    pub fn from_descriptor(descriptor: &P2pArtifactDescriptor) -> Result<Self> {
        serde_json::from_value(descriptor.metadata.clone()).context("parse layer metadata")
    }

    pub fn validate(&self, canonical: &CanonicalBlobIdentity) -> Result<()> {
...
pub fn layer_key_from_digest(digest: &str) -> P2pArtifactKey {
    layer_artifact_key(&CanonicalBlobIdentity::from_digest(digest))
}

pub fn layer_key_from_uuid(uuid: &Uuid) -> P2pArtifactKey {
    layer_artifact_key(&CanonicalBlobIdentity::from_uuid(uuid))
}

pub fn layer_artifact_key(canonical: &CanonicalBlobIdentity) -> P2pArtifactKey {
...
pub fn extract_sha256_digest(path: &str) -> Option<String> {
