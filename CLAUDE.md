...
- `crates/aenv-node`: the running half — Firecracker, ublk, overlaybd, image resolution, host setup, node gRPC service, the byte half of both snapshot backends, its half of the configuration. Ships `aenv-node`
