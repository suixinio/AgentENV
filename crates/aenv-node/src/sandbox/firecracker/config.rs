...
pub const MAX_EXTRA_DRIVES: usize = (b'z' - b'c' + 1) as usize;

#[derive(Debug)]
pub struct PersistentSnapshotRootGuard {
    path: PathBuf,
}
...
impl FirecrackerSandboxConfig {
    ...
    pub fn from_app_config_with_user_image(
        ...
        let runtime_upper_mode =
            crate::sandbox::ublk::upper_mode_for(ublk.overlaybd.runtime_upper_mode);
...
impl FirecrackerSnapshotConfig {
    pub fn from_runnable_snapshot(snapshot: &RunnableSnapshot) -> Result<Self> {
        ...
        let rootfs_image_config = OverlaybdConfig {
            ...
            runtime_upper_mode: crate::sandbox::ublk::upper_mode_for(
                app_config.ublk.overlaybd.runtime_upper_mode,
            ),
        };
