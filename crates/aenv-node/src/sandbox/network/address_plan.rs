...
impl NetworkAddressPlan {
    ...
    pub fn slot_ips(&self, idx: u32) -> Result<(Ipv4Addr, Ipv4Addr, Ipv4Addr)> {
    ...
    pub fn host_interaction_cidr(&self) -> Ipv4Network {
    ...
    pub fn vm_link_prefix(&self) -> u8 {
        self.vm_link_cidr.prefix()
    }

    pub fn vm_link_mask(&self) -> Ipv4Addr {
        self.vm_link_cidr.mask()
    }

    pub fn conflict_patterns(&self) -> Vec<String> {
        [
            self.host_interaction_cidr,
            self.veth_cidr,
            self.vm_link_cidr,
    ...
    pub fn internal_egress_denied_cidrs(&self) -> Vec<String> {
