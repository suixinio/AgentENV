...
impl DescriptorCache {
    pub fn new(hit_ttl: Duration, miss_ttl: Duration, max_entries: usize) -> Self {
        Self {
    ...
    pub fn get(&self, key: &P2pArtifactKey) -> Option<Option<P2pArtifactDescriptor>> {
    ...
    pub fn insert(&self, key: P2pArtifactKey, descriptor: Option<P2pArtifactDescriptor>) {
        self.inner.insert(
            key,
            CachedDescriptor {
    ...
    pub fn remove(&self, key: &P2pArtifactKey) {
        self.inner.remove(key);
    }
