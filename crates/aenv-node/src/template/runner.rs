...
pub struct TemplateBuildRunner {
    step_executor: TemplateStepExecutor,
}

#[derive(Clone, Debug)]
pub struct TemplateBuildExecution {
...
impl Default for TemplateBuildRunner {
    fn default() -> Self {
        Self::new()
    }
}
...
impl TemplateBuildRunner {
    ...
    pub fn execute(&self, context: &TemplateBuildContext) -> Result<TemplateBuildExecution> {
        match &context.base {
