...
impl NetworkManager {
    ...
    #[cfg(test)]
    pub fn new(maintenance_enabled: bool, low_watermark: usize, high_watermark: usize) -> Self {
    ...
    #[cfg(test)]
    pub fn allocate_test_slot(&self) -> Result<Slot> {
    ...
    pub fn cleanup_allocated_slot(&self, slot: Slot, sync_cleanup: bool) -> Result<()> {
