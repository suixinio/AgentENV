...
impl FirecrackerPool {
    ...
    pub fn try_acquire(&self) -> Option<WarmFirecracker> {
...
pub fn warm_stdout_path(work_dir: &Path) -> PathBuf {
    work_dir.join("firecracker-stdout.log")
}

pub fn warm_stderr_path(work_dir: &Path) -> PathBuf {
