...
/// The full OSS artifact store: [`OssSnapshotArtifactStore`]'s delete path plus
/// the import path that needs overlaybd.
pub struct OssSnapshotArtifactImporter {
...
#[async_trait]
impl SnapshotArtifactStore for OssSnapshotArtifactImporter {
...
impl OssSnapshotArtifactImporter {
    ...
    pub async fn derive_and_upload_disk_image_layers(
        &self,
        image_config_path: &Path,
        artifact: OssUploadArtifact,
...
pub fn fallback_to_object_storage_would_mix_sources(
    image_config_path: &Path,
    managed_layers_repo_blob_url: &str,
...
pub fn validate_publish_manifest_image_configs(
    manifest: &FirecrackerSnapshotManifest,
) -> RepositoryResult<()> {
...
mod tests {
    ...
    fn test_store() -> OssSnapshotArtifactImporter {
