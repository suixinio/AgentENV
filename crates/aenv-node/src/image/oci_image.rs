...
pub struct OverlaybdConversionEnv<'a> {
    pub install_root: &'a Path,
    pub global_config: &'a Path,
    pub converter_id: &'a str,
    pub regctl_binary: &'a Path,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct LayerConversionKey {
    pub source_layer_digest: String,
    pub converter_id: String,
    pub virtual_size_gib: u64,
    pub mkfs: bool,
    pub parent_commit_digest: Option<String>,
    pub expected_layer_uuid: Uuid,
}

#[async_trait]
pub trait ImageConversion: Send + Sync {
...
pub async fn fetch_oci_image_config_metadata(
    regctl_binary: &Path,
    image_ref: &str,
    config_digest: &str,
...
pub async fn convert_fetched_oci_image_to_overlaybd(
    image_ref: &str,
...
pub fn image_ref_with_digest(image_ref: &str, digest: &str) -> Result<String> {
