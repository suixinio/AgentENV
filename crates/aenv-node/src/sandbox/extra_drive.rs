...
pub use crate::types::drive::{ROOTFS_DRIVE_ID, USER_ROOTFS_DRIVE_ID};
pub use crate::types::ExtraDrive;
...
pub enum ExtraDrivePrepareMode {
...
impl PreparedDrives {
    pub fn into_parts(self) -> (Vec<DriveMount>, Vec<OverlaybdRuntimeHandle>) {
...
pub async fn prepare_extra_drives(
