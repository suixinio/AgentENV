...
pub fn write_generated_overlaybd_global_configs(
    config: &AppConfig,
...
pub fn file_exists_nonempty(path: &Path) -> bool {
    path.metadata()
...
pub fn copy_file(source: &Path, destination: &Path, executable: bool) -> Result<()> {
