...
pub enum OverlaybdCompactOutput {
    Raw,
    ZFile {
...
impl OverlaybdCompactOutput {
    ...
    pub fn from_memory_snapshot_config(config: &MemorySnapshotConfig) -> Self {
...
pub async fn create_commit_args(
...
pub async fn create_commit_args_with_digest(
    output: Arc<dyn VirtualFile>,
    mode: OverlaybdCompactOutput,
    concurrency: usize,
...
pub fn upper_mode_for(mode: crate::cfg::RuntimeUpperMode) -> UpperMode {
    match mode {
        ...
        crate::cfg::RuntimeUpperMode::LogStructured => UpperMode::LogStructured,
        crate::cfg::RuntimeUpperMode::HybridLogStructured => UpperMode::HybridLogStructured,
    }
}

#[derive(Clone, Debug)]
pub struct OverlaybdRuntimeHandle {
    pub device: UblkDevice,
    pub image_config_path: PathBuf,
