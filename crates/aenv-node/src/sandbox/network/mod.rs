//! `aenv-core`'s network policy, plus the namespaces and veth pairs a machine
//! actually creates.
...
pub use address_plan::NetworkAddressPlan;
pub use manager::NetworkManager;
pub use slot::Slot;

pub const MAX_SLOTS: usize = aenv_core::cfg::network::NETWORK_MAX_SLOTS;
const NETNS_PREFIX: &str = "agentenv-ns-";
const HOST_VETH_PREFIX: &str = "veth-";

pub fn prepare_runtime(runtime_path: &Path) -> anyhow::Result<()> {
